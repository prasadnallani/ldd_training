...
int init_module(void)
{
	...
	/* 
	   As per OAPIC Datasheet 0x00 is I/O REGISTER SELECT REGISTER 
	   of size 32 bits
	 */
	ioregsel = (void *)((long)io + 0x00);

	/* 
	   As per OAPIC Datasheet 0x10 is I/O WINDOW REGISTER of size
	   32 bits 
	 */
	...
	/* Read IOAPIC IDENTIFICATION 
	   As per OAPIC Datasheet IOAPIC IDENTIFICATION REGISTER 
	   Address Offset : 0x00 
